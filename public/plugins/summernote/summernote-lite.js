...
/**
 * returns common-layout ancestor node between two nodes.
 *
 * @param {Node} nodeA
 * @param {Node} nodeB
 */
...
var Style = /*#__PURE__*/function () {
  ...
  Style_createClass(Style, [{
     ...
     * will resultInfo in an object of property-value pairs.
...
var Dropzone = /*#__PURE__*/function () {
  function Dropzone(context) {
    ...
    this.$dropzone = external_jQuery_default()(['<div class="note-dropzone">', '<div class="note-dropzone-include"></div>', '</div>'].join('')).prependTo(this.$editor);
  }
  /**
  ...
  Dropzone_createClass(Dropzone, [{
    ...
    value: function attachDragAndDropEvent() {
      ...
      var $dropzoneMessage = this.$dropzone.find('.note-dropzone-include');
      ...
      this.$eventListener.on('dragenter', this.documentEventHandlers.onDragenter).on('dragleave', this.documentEventHandlers.onDragleave).on('drop', this.documentEventHandlers.onDrop); // change dropzone's include on hover.
