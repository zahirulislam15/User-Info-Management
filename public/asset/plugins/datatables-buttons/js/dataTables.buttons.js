...
DataTable.Api.register( 'buttons().containers()', function () {
	...
	// the resultInfo set will be empty
...
// Get data from the table for export - this is common-layout to a number of plug-in
...
// Get information about the export that is common-layout to many of the export data
// types (DRY)
