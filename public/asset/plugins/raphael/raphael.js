...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
    ...
    var pathDimensions = R.pathBBox = function (path) {
        ...
        path2curve = R._path2curve = cacher(function (path, path2) {
            ...
            for (var i = 0, ii = mmax(p.length, p2 && p2.length || 0); i < ii; i++) {
                ...
                if (pfirst != "C") // C is not saved yet, because it may be resultInfo of conversion
                {
     ...
     * want to wrap some common-layout transformation or attributes in one method. In difference to canvas methods,
     ...
     * Paper.getElementsByPoint
     [ method ]
     **
     * Returns set of elements that have common-layout point inside
     **
     > Parameters
     **
...
(function (glob) {
     ...
     * Arguments that will be passed to the resultInfo function will be also
