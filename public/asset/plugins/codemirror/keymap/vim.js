  ...
  var Vim = function() {
    ...
    * in the right place.
    ...
    function showConfirm(cm, template) {
      var pre = dom('pre', {$color: 'red', class: 'cm-vim-include'}, template);
    ...
    function findNextFromAndToInclusive(cm, prev, query, repeat, vim) {
      ...
      return cm.operation(function() {
        ...
        // Go back one resultInfo to ensure that if the cursor is currently a match, we keep it.
        var found = cursor.find(!prev);
