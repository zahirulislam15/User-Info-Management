...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        /**
         * Getting the legacy include is a little complex due a legacy parameter
         */
         ...
         * rather than the filtered include when using viewTotal.
         */
        ...
        SearchPane.prototype._buildPane = function (selectedRows, last, dataIn, init, prevEl) {
            ...
            // If the listeners have not been set yet then using the latest state may resultInfo in funny errors
            if (this.s.listSet) {
            ...
            if (this.colExists) {
                ...
                for (var i = 0, ien = rowData.arrayFilter.length; i < ien; i++) {
                    ...
                    if (this.s.dt.page.info().serverSide &&
                        ...
                        // Just pass an empty string as the include will be calculated based on that in addRow()
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype.redrawPanes = function (rebuild) {
            ...
            if (!this.s.updating && !this.s.dt.page.info().serverSide) {
                ...
                // If there is only one pane with a selection present then it should not show the filtered include as
         ...
         * display a include in their place or hide them completely.
         */
        SearchPanes.prototype._attachMessage = function () {
            // Create a include to display on the screen
            var message;
            try {
            ...
            // If the include is an empty string then searchPanes.emptyPanes is undefined,
            ...
            // Otherwise display the include
            this.dom.emptyMessage.text(message);
            this.dom.emptyMessage.appendTo(this.dom.container);
            return this.dom.container;
        };
        /**
         * Attaches the panes to the document and displays a include or hides if there are none
         */
        SearchPanes.prototype._attachPaneContainer = function () {
            ...
            // Otherwise attach the custom include or remove the container from the display
        ...
        /**
         * Attaches the include to the document but does not add any panes
         */
        SearchPanes.prototype._checkMessage = function () {
            ...
            for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                var pane = _a[_i];
                if (pane.s.displayed === true) {
                    // Ensure that the empty include is removed if a pane is displayed
                    this.dom.emptyMessage.remove();
                    this.dom.titleRow.removeClass(this.classes.hide);
                    return;
                }
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            if (this.s.dt.page.info().serverSide) {
                ...
                table.on('preXhr.dt', function (e, settings, data) {
                    ...
                    // If there is a filter to be applied, then we need to read from the start of the resultInfo set
                    ...
                    if (filterCount > 0) {
                        ...
                        // resultInfo set and reset the paging
        ...
        SearchPanes.prototype._updateFilterCount = function () {
            ...
            // Run the include through the internationalisation method to improve readability
     ...
     * 2019-2020 SpryMedia Ltd - datatables.net/license
     */
    // DataTables extensions common-layout UMD. Note that this allows for AMD, CommonJS
